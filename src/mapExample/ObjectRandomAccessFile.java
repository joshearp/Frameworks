...
public class ObjectRandomAccessFile extends RandomAccessFile
{
	...
	{		
		...
		{			
			try
			{
				...
				System.out.println("writeObject -- objectSize: " + objectSize + " recordNumber: " + recordNumber + " totalRecordLength: " + totalRecordLength + "\n") ;
			...
			{
				throw new IOException("An IOException occurred while writing data to the RandomAccessFile, " + fileName + ": " + ex.getMessage()) ;
			}
			
			catch (Exception ex)
			{
				throw new Exception("A generic Exception occurred while writing data to the RandomAccessFile, " + fileName  + ": " + ex.getMessage()) ;
			}
		}
	...
	{ 	
		...
		// System.out.println("top of readObject recordNumber: " + recordNumber + " file length: " + length() + "\n") ;
				
		int objectSize = readInt(); // read the first int in the file to get the recordLength that all records will have.

		//seek(0); // Re-position the read-write pointer at the beginning of the file -- byte 0.
		...
		// System.out.println("readObject -- objectSize: " + objectSize + " recordNumber: " + recordNumber + " totalRecordLength: " + totalRecordLength + "\n") ;
		...
		// System.out.println("readObject --  byteArray.length: " + byteArray.length + "\n") ;
				
		return obj;
	}
	
	public void updateRecord( int numberOfRecordToUpdate, Object replacementObject) throws IOException, EOFException, Exception
	{ 		
